...
// This is the static content requested for the 'Why Attend?' card
...
export default function EventDetailsPage() {
    ...
    // Use a placeholder ID or dynamically get it from URL/search params
    ...
    const fetchEventDetails = useCallback(async () => {
        ...
        if (error) {
            ...
            const mockDefaults = {
                ...
                // Ensure default values are applied if Supabase returns nulls for presentation
            };
                ...
                <div className="lg:col-span-1 space-y-8 sticky top-4">
                    ...
                    <Card title="Quick Actions" icon={<ExternalLink />}>
                        <div className="flex flex-col space-y-2">
                            <button onClick={() => alert('Registering for event...')} className="text-green-400 hover:text-green-500 text-left font-medium">
                                Register for Event
                            </button>
                            <button onClick={() => alert('Share function unavailable.')} className="text-gray-400 hover:text-gray-300 text-left font-medium">
                                Share with Friends
                            </button>
